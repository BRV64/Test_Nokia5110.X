 ...
 * 
 * ************************* Actualizaciones *************************************
 * A partir de la versi�n 1.35, el compilador XC8 deja de dar soporte a la librer�a
 * de retardos "delays.h". En esta versi�n se crea una nueva rutina de retardo 
...
/* Para los compiladores XC8 y HI-TECH PIC18 es necesario configurar manualmente
 la opci�n CODEOFFSET con el valor de 0x1000.
 ...
 */
    ...
    #pragma code
        ...
        #org 0, 0xFFF {}   /*Reservar �rea de memoria ocupada por el Bootloader de Alteri*/
#endif
/******************************************************************************************************/
